...
class ProfileScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: UAppBar(showBackArrow: true, title: Text('Profile')),
        ...
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              SizedBox(height: USizes.spaceBtwItems),
              ProfileMenu(title: 'User Id', value: controller.user.value.id, onPressed: (){}, icon: Iconsax.copy_copy,),
              ...
              ProfileMenu(title: 'Date of Birth', value: "6 July 2000", onPressed: (){}),
              Divider(),
              SizedBox(height: USizes.spaceBtwItems),
