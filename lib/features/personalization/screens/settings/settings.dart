              ...
              child: Column(
                children: [
                  ...
                  ListTile( 
                    ...
                    title: Obx(() => Text(controller.user.value.fullName, style: Theme.of(context).textTheme.headlineSmall!.apply(color: UColors.white))),
                    subtitle: Text(controller.user.value.email, style: Theme.of(context).textTheme.bodyMedium!.apply(color: UColors.white)),
                    trailing: IconButton(
                      onPressed: () => Get.to(() => ProfileScreen()),
                      icon: Icon(Iconsax.edit_copy, color: UColors.white),
                    ),
                  ),
