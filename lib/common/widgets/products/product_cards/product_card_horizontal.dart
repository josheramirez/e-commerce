              ...
              child: Stack(
                children: [
                  SizedBox(
                    height: 120,
                    width: 120,
                    child: RoundedImage(imageUrl: Images.productImage1, applyImageRadius: true)
                  ),
                  Positioned(
                    top: 12,
                ...
                Column(
                  children: [
                    Column(
                      ...
                      children: [
                        ProductTiitleText(title: 'Green Nike Half Sleeve', smallSize: true),
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: SizedBox(
                            ...
                            child: Center(child: Icon(Iconsax.add_copy, color: UColors.white)),
                          ),
                        )
                       ],
                    )
